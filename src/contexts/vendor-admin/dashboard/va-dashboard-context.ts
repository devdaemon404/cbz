...
type VADashboardContextDataType = {
  isLoading: boolean;
...
export const vaDashboardContextDefault: VADashboardContextDataType = {
  isLoading: false,
...
const VADashboardContext = createContext<VADashboardContextDataType>(
  vaDashboardContextDefault,
);

export default VADashboardContext;
