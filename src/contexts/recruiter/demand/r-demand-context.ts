...
export const rDemandContextDefault: RDemandContextDataType = {
  demands: [],
  profiles: [],
  openModal: false,
...
const RDemandContext = createContext<RDemandContextDataType>(
  rDemandContextDefault,
);

export default RDemandContext;
