...
export class PMWorkOrderApiService {
  private clientId;
  private userId;
  ...
  fetchAllWorkOrders = async (): Promise<WorkOrderDataType[] | null> => {
    const res = await this.httpClient.get<FetchAllWorkOrderResponseType>(
    ...
    console.log('From API: ', res.allWorkOrderData);
    return res.allWorkOrderData;
  };
