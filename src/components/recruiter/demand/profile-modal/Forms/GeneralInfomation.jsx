    ...
    <React.Fragment>
      <Grid container spacing={3}>
        <Grid item xs={12} sm={6}>
          ...
          <InputField name={firstname.name} fullWidth size='small' />
        </Grid>
        <Grid item xs={12} sm={6}>
          <Typography variant='body1' color='initial'>
            {lastname.label} <span style={{ color: 'red' }}>*</span>
          </Typography>
          <InputField name={lastname.name} fullWidth size='small' />
        </Grid>
        <Grid item xs={12} sm={6}>
          <Typography variant='body1' color='initial'>
            {email.label} <span style={{ color: 'red' }}>*</span>
          </Typography>
          <InputField name={email.name} fullWidth size='small' />
        </Grid>
        <Grid item xs={12} sm={6}>
          <Typography variant='body1' color='initial'>
        ...
        <Grid item xs={12} sm={6}>
          ...
          <InputField name={mobile.name} fullWidth size='small' />
        </Grid>
        <Grid item xs={12} sm={6}>
          <Typography variant='body1' color='initial'>
