        ...
        <Paper variant='outlined' className={classes.paperPadding}>
          <Grid container direction='row' spacing={2}>
            ...
            <Grid item xs={4}>
              ...
              <InputField name='o_town_city' placeholder='Enter Town/City' />
            </Grid>
            ...
            <Grid item xs={4}>
              ...
              <SelectField name='o_country' data={country} />
            </Grid>
            <Grid item xs={4}>
              <Typography variant='body1' color='initial'>
                Postal Code<span style={{ color: 'red' }}>*</span>
              </Typography>
              <InputField name='o_pin_code' placeholder='Enter Postal Code' />
            </Grid>
          </Grid>
        </Paper>
      </Grid>
